...
<header class="header">
        ...
        <div class="menu">
            ...
            <a href="wishlist.php">Wishlist <span class="heart">❤</span></a>
            <a href="cart.php">Cart <span class="cart">🛒</span></a>
        </div>
    </header>

    <nav class="nav">
        <div class="dropdown">
            <a href="#" class="dropdown-toggle">ALL CATEGORIES</a>
            <div class="dropdown-menu">
                <div class="category-list">
                    ...
                    <a href="#">Office Supplies & Stationery</a>
                    <a href="#">Books</a>
                    <a href="#">Music, Movies & TV Shows</a>
                    <a href="#">Automotive</a>
                </div>
                <div class="subcategory">
                    <h3>Electronics & Mobiles</h3>
